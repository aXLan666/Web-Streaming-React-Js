...
import Hero from "./HeroBakground.jsx";
...
const Carousel = () => {
    ...
    useEffect(() => {
        getFilms(); // Call the function to fetch films from the API
    }, []);
...
//                         <img
//                             className="image"
//                             src="http://localhost:5009/images/StarWarsTheMandalorHorizontal.jpeg"
//                             alt="Gradient Image"
//                         />
...
//                             </div>
//                             <div className=''>
//                                 <h1 className="text-white font-['rubik'] text-[32px]">The Mandalor</h1>
//                             </div>
//                             <div className=''>
//                                 <div className=''>2019/11/12</div>
//                             </div>
//                             <div className=''>
//                                 <p className='text-white'>The third season of the American television series The Mandalorian stars <br />
//                                     Pedro Pascal as the title character, a bounty hunter traveling to Mandalore to <br />
//                                     redeem his past transgressions with his adopted son Grogu and being aided <br />
//                                     on their journey by fellow Mandalorian Bo-Katan Kryze.</p>
//                             </div>
//                             <div className='mt-5'>
...
//                         <img
//                             className="image"
//                             src="http://localhost:5009/images/OppenheimerHorizontal.jpeg"
//                             alt="Gradient Image"
//                         />
//                         <div className='absolute bottom-20 left-10'>
//                             <div className='rounded-full bg-purple500 text-center w-fit h-fit mb-5 cursor-pointer'>
...
//                         <img
//                             className="image"
//                             src="http://localhost:5009/images/StarWarsTheForceAwakensHorizontal.jpg"
//                             alt="Gradient Image"
//                         />
//                         <div className='absolute bottom-20 left-10'>
//                             <div className='rounded-full bg-purple500 text-center w-fit h-fit mb-5 cursor-pointer'>
