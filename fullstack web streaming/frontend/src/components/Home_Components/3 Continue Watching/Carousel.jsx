...
function ContinueWatching() {
  ...
  return (
    <div className="flex flex-col bg-black800 h-[393px] m-auto p-auto relative">
      ...
      >
        ...
        <div className="flex flex-nowrap ml-7 mt-4">
          <div className="inline-block px-3">
            <div className="btn flex w-[425px] h-[310px] max-w-xs overflow-hidden rounded-lg shadow-md bg-black900 hover:shadow-xl transition-shadow duration-300 ease-in-out justify-center">
              <img
                src="" alt=""
          ...
          <div className="inline-block px-3">
            <div className="btn flex w-[425px] h-[310px] max-w-xs overflow-hidden rounded-lg shadow-md bg-black900 hover:shadow-xl transition-shadow duration-300  justify-center">
              <img
                src="" alt=""
